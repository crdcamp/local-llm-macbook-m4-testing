...
I want a local LLM research assistant that runs smoothly on **Apple M4 silicone**. I'll make a bunch of tools and stuff like that for it to work well. I think AI is best used for gathering information and presenting it to you. It's up to the user to actually investigate and understand their desired material. 
